...
function _renderShareBar(article,slug){
  ...
  // articolo.html è la pagina proxy con OG meta dinamici — usala per la condivisione
  const shareUrl=`https://mattiafarinaro.github.io/articolo.html?a=${encodeURIComponent(slug)}`;
  const title=article.titolo||'Articolo di Mattia Farinaro';
